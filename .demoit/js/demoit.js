...
.browser i:nth-child(1) {background-color: rgb(37, 198, 58); border: 0.5px solid rgb(17, 178, 38);}
.browser i:nth-child(1):hover {background-color: rgb(10, 225, 10)}
...
<div class="browser-navigation-bar">
    <i class="green"></i>
    <span class="title">shell ~ ${path}</span>
